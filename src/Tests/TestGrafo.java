...
public class TestGrafo {
        public static void main(String[] args) {
                ...
                Ciudad cipo = new Ciudad("Cipolletti", false, false);
                Ciudad nqn = new Ciudad("Neuquen", true, true);
                Ciudad seni = new Ciudad("Senillosa", false, false);
                Ciudad plot = new Ciudad("Plottier", true, true);
                Ciudad roca = new Ciudad("General Roca", true, true);
                Ciudad allen = new Ciudad("Allen", false, false);
                Ciudad regina = new Ciudad("Villa Regina", true, true);
                Ciudad cs = new Ciudad("Cinco Saltos", false, false);
                Ciudad cutral = new Ciudad("Cutral Co", true, true);
                Ciudad cente = new Ciudad("Centenario", false, false);
                Ciudad sm = new Ciudad("San Martin de los Andes", true, true);
                Ciudad zap = new Ciudad("Zapala", false, false);
                Ciudad chosma = new Ciudad("Chos Malal", true, true);
                Ciudad rincon = new Ciudad("Rincon de los Sauces", false, false);
                Ciudad cholar = new Ciudad("El Cholar", true, true);
                Ciudad huecu = new Ciudad("El Huecu", false, false);
                Ciudad picun = new Ciudad("Picun Leufu", true, true);
                Ciudad cav = new Ciudad("Caviahue", false, false);
